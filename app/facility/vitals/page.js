...
export default function FacilityVitalsPage(props) {
  return (
    <Suspense fallback={<div className="p-6 text-sm text-slate-500">Loading...</div>}>
      <FacilityVitalsPageInner {...props} />
    </Suspense>
  );
}
...
function FacilityVitalsPageInner() {
  ...
  const updateQuery = (patch) => {
    ...
    if ("patient" in patch || "limit" in patch) {
      params.set("page", "1");
    }
    ...
    return (
      <main className="mx-auto max-w-7xl p-6 md:p-10">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="h-1.5 w-full bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 rounded-t-xl -mt-6 mb-4" />
      ...
      <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <h1 className="mt-2 text-2xl md:text-3xl font-semibold tracking-tight text-slate-900">
            Vitals across your clinic
          </h1>
          <p className="mt-1 text-sm text-slate-500">
            Review recorded vitals by patient and time.
          </p>
        </div>
              ...
              <tr>
                <td colSpan={8} className="px-4 py-10 text-center">
                  ...
                  <div className="mt-1 text-sm text-slate-500">
                    New readings will appear here automatically.
                  </div>
                </td>
              </tr>
            )}
