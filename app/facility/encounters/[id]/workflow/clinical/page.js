...
import { ArrowLeft, Loader2, AlertTriangle, Save, Lock, ChevronRight } from "lucide-react";
      ...
      <div className="mb-4 flex items-start justify-between gap-4">
        <div>
          ...
          <div className="mt-1 flex flex-wrap items-center gap-2 text-sm text-slate-600">
            ...
            <span>•</span>
            <span>Status: <span className="font-medium text-slate-900">{encounter?.status || "—"}</span></span>
            {isLocked ? (
              <>
                <span>•</span>
            ...
            {lockDueAt ? (
              <>
                <span>•</span>
                <span>Lock due: <span className="font-medium text-slate-900">{fmtDateTime(lockDueAt)}</span></span>
              </>
            ) : null}
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Link
            href={`/facility/encounters/${encounterId}/workflow/labs`}
