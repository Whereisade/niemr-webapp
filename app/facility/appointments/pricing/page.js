                ...
                return (
                  <article
                    ...
                    className={`rounded-xl border p-3 ${
                      isSet ? "border-slate-200 bg-white" : "border-amber-200 bg-amber-50/40"
                    }`}
                  >
                        ...
                        <div className="space-y-2">
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full rounded-lg border border-blue-300 bg-blue-50 py-2 pl-6 pr-3 text-right text-sm font-semibold text-slate-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
                              autoFocus
                              disabled={updating}
                            />
                          </div>
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              disabled={updating}
                              className="inline-flex items-center rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-emerald-700 hover:bg-emerald-100 disabled:opacity-60"
                              title="Save price"
                            >
                              {updating ? (
                            ...
                            <button
                              ...
                              onClick={cancelEdit}
                              disabled={updating}
                              className="inline-flex items-center rounded-lg border border-slate-200 bg-white px-3 py-2 text-slate-600 hover:bg-slate-50 disabled:opacity-60"
                              title="Cancel"
                            >
                              <X className="h-4 w-4" />
                            </button>
                            ...
                            {isSet ? (
                              <>
                                <div className="font-semibold text-slate-900">
                                  â‚¦{formatMoney(facilityPrice)}
                                </div>
                                <div className="text-xs font-medium text-emerald-600">Price set</div>
                              </>
                            ) : (
                              <>
                                <div className="font-semibold text-amber-600">Not Set</div>
