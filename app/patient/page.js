  ...
  return (
    <main className="mx-auto max-w-7xl p-6 md:p-10">
      <header className="mb-8">
        <h1 className="text-2xl md:text-3xl font-semibold tracking-tight text-slate-900">Patient Home</h1>
      ...
      <section className="grid gap-4 md:grid-cols-3 mb-8">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5">
          <p className="text-sm text-slate-600">New Notifications (7d)</p>
          <p className="mt-1 text-3xl font-semibold">{notifList.length}</p>
        </div>
        <a href="/patient/appointments"
          ...
          <p className="text-sm text-slate-700">Appointments</p>
          <p className="mt-1 text-lg font-semibold text-slate-900">View all →</p>
        </a>
      </section>

      <section className="mb-10">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg font-semibold text-slate-900">My Upcoming Appointments</h2>
          <a href="/patient/appointments" className="text-sm text-blue-700 hover:underline">View all</a>
        </div>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              {appts.length ? appts.map(a => (
                ...
                <tr><td colSpan={4} className="px-4 py-6 text-slate-600">No upcoming appointments.</td></tr>
              )}
            </tbody>
          </table>
        </div>
      ...
      <section>
        <div className="flex items-center justify-between mb-3">
          ...
          <a href="/patient/notifications" className="text-sm text-blue-700 hover:underline">View all</a>
        </div>
