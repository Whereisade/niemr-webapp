      ...
      <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            View the bills and charges that have been raised for your
            care, and your current balance.
          </p>
        </div>
          ...
          <button
            ...
            onClick={async () => {
              try {
                ...
                if (!pid) {
                  alert(
                    "Unable to determine your patient ID for billing report."
                  );
                  return;
                }
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Charges, payments, and outstanding balance for your
              account.
            </p>
            {ledgerError && (
