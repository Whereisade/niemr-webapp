      ...
      <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            A record of your past and ongoing visits with facilities and providers.
          </p>
        </div>
              ...
              <tr key={enc.id} className="transition hover:bg-slate-50/60">
                ...
                <Td>
                  <span className="inline-flex items-center gap-2 text-slate-700">
                    ...
                    {enc.facility_name || enc.facility || "—"}
                  </span>
                </Td>
                <Td>
            ...
            {!rows.length && (
              <tr>
                <td colSpan={5} className="px-4 py-10 text-center">
                  ...
                  <div className="mt-1 text-sm text-slate-500">Try adjusting your search or status filter.</div>
                </td>
              </tr>
            )}
          </tbody>
