      ...
      <div className="container grid items-center gap-10 py-10 md:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-2 text-slate-600">
            Write notes, place orders, e-prescribe, and manage your patient panel — fast and secure.
          </p>

          <ul className="mt-5 grid gap-3 text-sm">
            <li className="flex items-center gap-2">
              <ClipboardCheck className="h-4 w-4 text-emerald-700" />
              <span>Status-driven visits from check-in to discharge</span>
            </li>
            <li className="flex items-center gap-2">
              <FileText className="h-4 w-4 text-violet-700" />
              <span>Audit-ready notes with amend/close/cross-out</span>
            </li>
            <li className="flex items-center gap-2">
              <Pill className="h-4 w-4 text-fuchsia-700" />
              <span>e-Rx with dispensing and inventory visibility</span>
            </li>
          </ul>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Use your verified provider account.
                  </p>
                </div>
              </div>
            </div>
