...
export default function ProviderEncounterWaitingLabsPage() {
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <div className="mt-1 text-sm text-amber-900/80">
              Resume to continue to SOAP note, or skip labs to continue without results.
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 rounded-2xl border border-slate-100 bg-white p-4 shadow-sm">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="text-xs text-slate-600">
              {orders.length ? `${orders.length} order(s)` : "No orders found for this encounter"}
            </div>
          </div>
