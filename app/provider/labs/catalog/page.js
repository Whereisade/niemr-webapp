...
export default function ProviderLabCatalogPage() {
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <h1 className="text-lg font-semibold text-slate-900">
                Independent Lab Catalog
              </h1>
              <p className="mt-1 text-xs text-slate-500">
                Manage your independent lab test catalog. Import from CSV/Excel or add tests individually.
              </p>
            </div>
          </div>
        ...
        <section className="rounded-2xl border border-teal-200 bg-teal-50/50 p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-semibold text-teal-900">File Format Requirements</h3>
              ...
              <div className="mt-2 grid gap-2 sm:grid-cols-2">
                <div className="rounded-lg border border-teal-200 bg-white px-3 py-2">
                  <div className="text-xs font-semibold text-teal-900">Required Columns:</div>
                  <ul className="mt-1 space-y-0.5 text-xs text-teal-700">
                    <li>• <code className="rounded bg-teal-100 px-1 py-0.5 font-mono text-[11px]">code</code> - Test code (e.g., FBC_HB)</li>
                    <li>• <code className="rounded bg-teal-100 px-1 py-0.5 font-mono text-[11px]">name</code> - Test name (e.g., Full Blood Count)</li>
                  </ul>
                </div>
                <div className="rounded-lg border border-teal-200 bg-white px-3 py-2">
                  <div className="text-xs font-semibold text-teal-900">Optional Columns:</div>
                  <ul className="mt-1 space-y-0.5 text-xs text-teal-700">
                    <li>• <code className="rounded bg-teal-100 px-1 py-0.5 font-mono text-[11px]">unit</code> - Unit of measurement (e.g., g/dL)</li>
                    <li>• <code className="rounded bg-teal-100 px-1 py-0.5 font-mono text-[11px]">ref_low</code> - Reference range low (e.g., 11.5)</li>
                    <li>• <code className="rounded bg-teal-100 px-1 py-0.5 font-mono text-[11px]">ref_high</code> - Reference range high (e.g., 15.0)</li>
                    <li>• <code className="rounded bg-teal-100 px-1 py-0.5 font-mono text-[11px]">price</code> - Test price (e.g., 3500)</li>
                  </ul>
                </div>
              </div>
          ...
          <div className="space-y-4">
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              <div className="mb-3 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="grid h-8 w-8 place-items-center rounded-lg bg-teal-50">
              ...
              <form onSubmit={handleCreate} className="space-y-3 text-xs">
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-slate-200 bg-slate-50 px-2 py-1.5 text-xs outline-none ring-0 focus:border-teal-500 focus:bg-white focus:ring-1 focus:ring-teal-500"
                    />
                  </div>
                ...
                <div className="flex items-center justify-end gap-2 pt-1">
                  <button
                    type="submit"
                    disabled={creating}
                    className="inline-flex items-center gap-1 rounded-lg bg-teal-600 px-3 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-teal-700 disabled:cursor-not-allowed disabled:opacity-60"
                  >
            ...
            <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-full rounded-full border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs outline-none ring-0 focus:border-teal-500 focus:bg-white focus:ring-1 focus:ring-teal-500 sm:w-64"
                />
              </div>
            </div>
                          ...
                          {editingTestId === t.id ? (
                            <div className="flex items-center justify-end gap-1">
                              <input
                                ...
                                className="w-20 rounded border border-teal-300 bg-teal-50 px-2 py-1 text-xs text-slate-900 focus:border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500"
                                autoFocus
                                disabled={updating}
                              />
                              <button
                            ...
                            <div className="flex items-center justify-end gap-1">
                              ...
                              <button
                                type="button"
                                onClick={() => startEditPrice(t)}
                                className="inline-flex items-center rounded border border-slate-200 bg-white p-1 text-slate-400 hover:border-teal-300 hover:bg-teal-50 hover:text-teal-600 transition-colors"
                                title="Edit price"
                              >
                                <Edit2 className="h-3 w-3" />
                              </button>
