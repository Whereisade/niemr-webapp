...
// ----------------------------------------------------------
// 📌 Convenience helpers for common report types (PATCH ADDED)
// ----------------------------------------------------------
...
/**
 * Billing report helper.
 *
 * Depending on your backend, ref_id might be:
 *  - a BillingAccount / Ledger id
 *  - a specific charge/payment id
 * 
 * For now we wire to refId directly.
 */
